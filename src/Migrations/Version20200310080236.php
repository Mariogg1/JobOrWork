 ...
 */
final class Version20200310080236 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oferta ADD empresa_id INT NOT NULL, ADD candidat_id INT DEFAULT NULL');
